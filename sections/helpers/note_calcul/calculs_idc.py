...
def fonction_idc_bww_energie_finale_ecs_comptage_ecs_inclus_mj(
    ...
    """
    try:
        if idc_eww_pondere_mj_m2 >= 0 and idc_sre_m2 > 0:
            idc_bww_energie_finale_ecs_comptage_ecs_inclus_mj = (
                idc_eww_pondere_mj_m2 * idc_sre_m2 * (periode_nb_jours / 365)
            )
        else:
...
def fonction_idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2(idc_bww_energie_finale_ecs_comptage_ecs_inclus_mj, idc_sre_m2):
    """
    Eww part d'énergie finale pour l'ECS dans le cas de comptage ECS inclus. Valeur théorique SIA 380/1 pondérées par affectation(s).
    """
    try:
        if idc_sre_m2 > 0:
            idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2 = (
                idc_bww_energie_finale_ecs_comptage_ecs_inclus_mj / idc_sre_m2
            )
        else:
            idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2 = 0
    except Exception as e:
        print(e)
        idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2 = 0
    return idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2


# C120 → Bww énergie finale pour le chauffage
def fonction_idc_bh_energie_finale_chauffage_comptage_ecs_inclus_mj(
    ...
    try:
        if (
            ...
            idc_bww_energie_finale_chauffage_comptage_ecs_inclus_mj = ((
            ...
            idc_bww_energie_finale_chauffage_comptage_ecs_inclus_mj = 0
    except Exception as e:
        print(e)
        idc_bww_energie_finale_chauffage_comptage_ecs_inclus_mj = 0
    return idc_bww_energie_finale_chauffage_comptage_ecs_inclus_mj



# C123 → Part d'énergie finale pour le chauffage avec correction climatique
def fonction_idc_eh_part_energie_finale_chauffage_climatiquement_corrige_comptage_ecs_inclus_mj_m2(
    ...
    try:
        if idc_sre_m2 > 0 and DJ_REF_ANNUELS > 0 and dj_periode > 0 and idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2 > 0:
            idc_eh_part_energie_finale_chauffage_climatiquement_corrige_comptage_ecs_inclus_mj_m2 = (
        (idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2 / idc_sre_m2)/(DJ_REF_ANNUELS/dj_periode))
        else:
...
def fonction_idc_resultat_comptage_ecs_inclus_mj_m2(
    ...
    """
    try:
        if idc_eh_part_energie_finale_chauffage_climatiquement_corrige_comptage_ecs_inclus_mj_m2 > 0 and idc_eww_part_energie_finale_ecs_comptage_ecs_inclus_mj_m2 > 0:
...
def fonction_idc_bh_energie_finale_chauffage_comptage_ecs_non_inclus_mj(
    ...
    try:
        if (
            ...
            idc_bww_energie_finale_chauffage_comptage_ecs_non_inclus_mj = ((
                idc_agent_energetique_ef_cad_reparti_kwh * IDC_CONVERSION_CAD_REPARTI_MJ_KWH * IDC_FACTEUR_PONDERATION_CAD +
                idc_agent_energetique_ef_cad_tarife_kwh * IDC_CONVERSION_CAD_TARIFE_MJ_KWH * IDC_FACTEUR_PONDERATION_CAD +
                idc_agent_energetique_ef_electricite_pac_avant_kwh * IDC_CONVERSION_ELECTRICITE_PAC_AVANT_MJ_KWH * IDC_FACTEUR_PONDERATION_ELECTRICITE_PAC_AVANT +
                idc_agent_energetique_ef_electricite_pac_apres_kwh * IDC_CONVERSION_ELECTRICITE_PAC_APRES_MJ_KWH * IDC_FACTEUR_PONDERATION_ELECTRICITE_PAC_APRES +
                ...
                idc_agent_energetique_ef_plaquettes_m3 * IDC_CONVERSION_PLAQUETTES_MJ_M3 * IDC_FACTEUR_PONDERATION_PLAQUETTES +
                idc_agent_energetique_ef_plaquettes_kwh * IDC_CONVERSION_PLAQUETTES_MJ_KWH * IDC_FACTEUR_PONDERATION_PLAQUETTES +
                idc_agent_energetique_ef_autre_kwh * IDC_CONVERSION_AUTRE_MJ_KWH * IDC_FACTEUR_PONDERATION_AUTRE) - idc_bww_energie_finale_ecs_comptage_ecs_non_inclus_mj)
        else:
            idc_bww_energie_finale_chauffage_comptage_ecs_non_inclus_mj = 0.0
    except Exception as e:
        print(e)
        idc_bww_energie_finale_chauffage_comptage_ecs_non_inclus_mj = 0.0
    return idc_bww_energie_finale_chauffage_comptage_ecs_non_inclus_mj
...
def fonction_idc_eh_part_energie_finale_chauffage_climatiquement_corrige_comptage_ecs_non_inclus_mj_m2(
    ...
    try:
        if idc_sre_m2 > 0 and DJ_REF_ANNUELS > 0 and dj_periode > 0 and idc_eww_part_energie_finale_ecs_comptage_ecs_non_inclus_mj_m2 > 0:
            idc_eh_part_energie_finale_chauffage_climatiquement_corrige_comptage_ecs_non_inclus_mj_m2 = (
        (idc_eww_part_energie_finale_ecs_comptage_ecs_non_inclus_mj_m2 / idc_sre_m2)/(DJ_REF_ANNUELS/dj_periode))
        else:
